...
> **Todas empiezan con `Hayao Miyazaki style, Satoshi Kon mood, hand-painted 2D anime style`.** Formato 21:9. Sin texto en la imagen.
...
- **Location:** Make a location sheet of Erdia's living surface in a wide establishing view: a lush, green, healthy hand-painted landscape — rolling emerald hills, forests and bright meadows under a clear blue sky, everything vivid and alive — with ONE small, dark, ominous crack fracturing the ground in the middle distance: a tiny wound in an otherwise thriving world.
...
- **Negative:** gentle stylized action, no photorealism, no 3D render, no CGI, no hyper-detailed rendering, no busy micro-texture, no characters, no people, no text, no watermark, no logos, no spaceships.
...
- **Negative:** gentle stylized action, no photorealism, no 3D render, no CGI, no hyper-detailed rendering, no busy micro-texture, no characters, no people, no spaceships, no text, no watermark, no logos.
...
- **Negative:** gentle stylized action, no photorealism, no 3D render, no CGI, no hyper-detailed rendering, no busy micro-texture, no characters, no people, no body in the tank, no text, no watermark, no logos.
