# PELÍCULA 1 — MAPA DE ESTRUCTURA Y DEBILIDADES

> Puntaje del borrador actual: **7.5 / 10** (techo del concepto: 9).
> Leyenda: 💪 fuerte · ⚠️ revisar · ➕ falta/agregar · ✂️ posible recorte

| # | Secuencia | Estado | Nota + opción corta |
|---|---|---|---|
| 1 | Prólogo: brote verde en tierra muerta | 💪 | Gancho misterioso; rima con el final de la trilogía. |
| 2 | Utopía naiel | 💪 | Mundo propio. ➕ sembrar al Rey amado/imperio. |
| 3 | Stella+Gix jugando / pasillo Vera y Selka | 💪 | Calidez que pagará caro. |
| 4 | Naio descubre ("agua estancada") | 💪 | ➕ sembrar la regla del Orbe (no se toma por fuerza). |
...
| 13 | Entrenamiento / dominar el Orbe | 💪 | "Pasaste limpio". |
| 14 | Lazos con Brog y Nima | ➕ | Lo más flojo; el final depende de quererlos. 2 escenas propias. |
| 15 | Erdia se pudre + propaganda + Selka General | 💪 | "La que estancó la luz". |
| 16 | Vera resistencia + su muerte (año 10) + mentira | ⚠️ | Hacer su muerte escena épica intercalada, no resumen. |
| 17 | Regreso disfrazada + mundo podrido | 💪 | El pelo manchado como lenguaje visual. |
| 18 | Reencuentro con Naio (minas) | 💪 | ➕ plantar que solo él rehace la máquina (pago Peli 3). |
...
## Accionables
- ✂️ Fundir la triple secuencia de escape (#9-10) en una sola ráfaga.
