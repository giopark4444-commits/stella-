...
>
> **Ajustes fijos:** Motor `gpt_image_2` (GPT Image 2 · OpenAI) · 16:9 · calidad high · 2k · estilo Studio painterly watercolor · location/character sheet.
...
> **Versión final:** rehechas con prompt corto `Studio painterly watercolor anime background painting, cinematic widescreen establishing shot, no characters. [1 frase]`. Estos job_ids son los buenos (se descartaron las versiones de prompt largo y las de Nano Banana).
...
### Arranque `[PILOTO]` — todas en 16:9, painterly watercolor acentuado
...
### Más adelante `[futuro]` — todas en 16:9, painterly watercolor acentuado
| # | Archivo | Tag | Personaje | Estado | ref_id (16:9) |
|---|---------|-----|-----------|--------|---------------|
...
- **Personajes:** 14/14 ✅ (16:9, painterly watercolor acentuado; 12 en formato "single figure", stella_14 y selka_4 en versión previa por el filtro)
