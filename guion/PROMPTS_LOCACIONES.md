...
> **Todas empiezan con `hand-painted 2D anime style`.** Formato 21:9. Sin texto en la imagen.
...
- **Negative:** no photorealism, no 3D render, no CGI, no hyper-detailed rendering, no busy micro-texture, no characters, no people, no text, no watermark, no logos, no spaceships.
...
- **Mood:** grim, alien, a cage that moves.
- **Negative:** no photorealism, no 3D render, no CGI, no hyper-detailed rendering, no busy micro-texture, no characters, no people, no text, no watermark, no logos.
...
- **Negative:** no photorealism, no 3D render, no CGI, no hyper-detailed rendering, no busy micro-texture, no characters, no people, no spaceships, no text, no watermark, no logos.
...
- **Negative:** no photorealism, no 3D render, no CGI, no hyper-detailed rendering, no busy micro-texture, no characters, no people, no body in the tank, no text, no watermark, no logos.
