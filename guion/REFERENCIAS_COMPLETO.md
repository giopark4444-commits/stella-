# MAPA MAESTRO DE REFERENCIAS · TODA LA PELÍCULA 1
## Stella Fugaz · "El Nodo de Erdia" — @elementos para Higgsfield/Seedance
...
## 🌍 LOCACIONES (17) — *generar establishing y reusar como `@location`*
| @tag | Qué | Actos | Establishing |
|---|---|---|---|
...
| `@MinasNiebla` | minas de niebla | A2 | CLIP 142 |
| `@RefugioResistencia` | refugio de la resistencia | A2 | CLIP 105 |
| `@AposentosGeneral` | aposentos de la General | A2 | CLIP 146 |
| `@ErdiaRuinas` | Erdia gris y partida (Año 8/20) | A2·A3 | CLIP 104/155 |
| `@SalaTrono` | sala del trono (clímax) | A3 | CLIP 176 |
