...
**LOS TRES HUMANOS** —**@char_noah** con una **espada**, **@carl** con una **lanza**, **@char_lucy** con un **arco**— aguantan un flanco espalda contra espalda, rotando, cubriéndose los ángulos ciegos.
...
> 🏷️ **LOCACIÓN** · `@loc_luzagua-park`
> 🏷️ **REPARTO** · `@stella-cloths` · `@vera-luzagua-park` · `@selka-baby` · `@gix`
...
**@stella-cloths** (14) corre por **el borde de un canal elevado** —un acueducto abierto por el que baja la **luzagua**, agua y luz a la vez—. Descalza, sobre piedra mojada, **a seis metros del suelo**, con los brazos abiertos.
...
ABAJO, en el césped, **@vera-luzagua-park** (madre, ~40, pelo blanco recogido, ojos gris-azul) está agachada al borde del canal. **No está mirando a su hija.**
...
Vera se gira un poco. Y ahí está, dormida en el fular: **@selka-baby** (1 año, pelo blanco, ojos gris-azul).
...
Porque ve a **@vera-armor** y a su padre **@naio** (~45, **el científico del Rey** —su laboratorio está dentro del propio palacio—) de pie frente a una proyección de datos. Ninguno de los dos se ríe. Tienen la cara de alguien que acaba de ver algo que no se puede des-ver.
...
En los brazos de su madre, **@selka-baby** sigue dormida. Vera aprieta un poco más a la bebé contra el pecho.
...
> 🏷️ **LOCACIÓN** · `@erdia-palace-corridors`
> 🏷️ **REPARTO** · `@stella-armor` · `@vera-armor` · `@selka-baby`
> 🏷️ **PROPS** · `⚠️ escudo de Vera — FALTA · @prop_stella-bracelet`
...
A su derecha, **@robot-s1g1** —un robot distinto: oscuro, esbelto, rápido, sin el ruido de los demás. Un asesino.

Y a su izquierda, un **@robot-giant-demoledor** de tres metros, que tiene que agachar la cabeza para pasar por la puerta.
...
Mientras, **@robot-s1g1** va a por Vera.
...
> 🏷️ **LOCACIÓN** · `@loc_erdia-orbe-room-destroyed · @loc_duct`
> 🏷️ **REPARTO** · `@robot-s1g1` · `@stella-short-hair-armor-blood` · `@vera-more-blood` · `@vortham` · `@selka-baby`
> 🏷️ **PROPS** · `⚠️ muñequera — FALTA · @prop_stella-bracelet`
...
**@robot-s1g1** se levanta, dispara sus propulsores y la persigue dentro del túnel, ganando terreno, a centímetros de sus botas.
...
> 🏷️ **LOCACIÓN** · `@loc_erdia-past`
> 🏷️ **REPARTO** · `@char_erdian-people` · `@stella-short-hair-armor-blood`
> 🏷️ **PROPS** · `@ship-stella · @ship-enemy-erdia · @ship-4-enemyy · @ship-erdia-1`
...
> 🏷️ **REPARTO** · `@brogu` · `@nima` · `@vosk` · `@gara` · `@enko` · `@hessa` · `@sabo` · `@thara` · `@theron` · `@stella-short-hair-armor-blood`
> 🏷️ **PROPS** · `@prop_orb · @prop_stella-bracelet`


`@loc_modershipo-hospital`. Luz blanca, quirúrgica.

Una mesa larga de metal. Encima, boca arriba, **@stella-short-hair-armor-blood.** Catorce años. Inconsciente.
...
> 🏷️ **LOCACIÓN** · `@loc_modershipo-hospital`
> 🏷️ **REPARTO** · `@theron` · `@stella-short-hair-armor-blood`
> 🏷️ **PROPS** · `@prop_stella-bracelet`
...
Sobre la mesa, **@stella-short-hair-armor-blood.**
...
> 🏷️ **LOCACIÓN** · `@loc_rebel-house`
> 🏷️ **REPARTO** · `@marek` · `@char_vera-rebel-hoodie`
...
> 🏷️ **LOCACIÓN** · `@loc_erdia-palace-traingin-room`
> 🏷️ **REPARTO** · `@selka-girl` · `@vortham-no-coat`


CORTE DIRECTO desde el refugio: de un cuarto oscuro lleno de gente que se quiere, a una sala blanca, altísima y vacía.

**@selka-girl.** Nueve años. Pelo blanco recogido con disciplina, ojos gris-azul. **Sin cicatriz.**
...
Desde la penumbra, sentado, **@vortham-no-coat** mira.
...
**@char_noah** —joven, magullado, con los nudillos partidos de otras veces y unos ojos que no se rinden.
...
**@char_noah** y **@carl** se miran un segundo. Y se abren, uno por cada lado.
...
**@char_noah** mira esa mano abierta. Mira las gradas. Y se levanta él solo.
...
**@char_lucy** es la que más tarda. Se queda sentada en el polvo, mirándola desde abajo.
...
Al pecho del **@junk-king**, y a la cosa pequeña y vieja que le cuelga del cuello.
...
> 🏷️ **LOCACIÓN** · `@loc_nimas-laboratory`
> 🏷️ **REPARTO** · `@nima` · `@char_noah` · `@stella-short-hair-theron`


**Agua oscura en un lavabo de metal.** Dentro, mechones de **pelo blanco** perdiendo el color.

**@nima** se lo tiñe con un cuidado de laboratorio, midiendo la mezcla como si fuera un reactivo. **@stella-short-hair-theron**, sentada, con la cabeza inclinada, mirando el agua ponerse negra.
...
**@char_noah** entra por detrás y se frena medio segundo antes de reconocerla.
...
> 🏷️ **LOCACIÓN** · `⚠️ planeta de los cometas — FALTA · @loc_nimas-laboratory`
> 🏷️ **REPARTO** · `@brogu` · `@nima` · `@char_noah` · `@stella-long-hair-theron` · `@gix`
> 🏷️ **PROPS** · `⚠️ espada, lanza y arco — FALTAN · @prop_stella-armor-ver-1-1`
...
> 🏷️ **LOCACIÓN** · `@mothership-control-room`
> 🏷️ **REPARTO** · `@theron` · `@stella-long-hair-theron`
...
> 🏷️ **LOCACIÓN** · `@loc_prison-corridor · @loc_prison-cell`
> 🏷️ **REPARTO** · `@marek` · `@korin-2` · `@char_lessa` · `@vera-rebel` · `@naio-prison`
...
**@marek** abre una reja de servicio con una llave que no debería tener. **@korin-2** y **@char_lessa** cubren la boca del pasillo.
...
**@vera-rebel** entra sola. Camina entre las celdas. Busca. Encuentra.

**@naio-prison.** Anciano, roto, irreconocible. Se arrastra hasta los barrotes cuando ella se baja la capucha lo justo para que él la vea.
...
> 🏷️ **LOCACIÓN** · `@selkas-dorm`
> 🏷️ **REPARTO** · `@marek` · `@korin-2` · `@char_lessa` · `@vera-rebel` · `@selka-teen`


Suben desde las celdas por escaleras de servicio. **@korin-2** y **@char_lessa** se quedan cubriendo el pasillo. **@marek** la acompaña hasta la puerta de los aposentos.
...
Adentro, de espaldas, está **@selka-teen** —quince años, todavía cadete, pero con aposentos propios dentro del palacio: la protegida personal del Rey, y todo el mundo lo sabe. Blanca, impecable, fría, de ojos gris-azul, con la cicatriz sobre el ojo izquierdo que lleva desde los nueve años.
...
Desde la puerta entreabierta, **@korin-2** y **@char_lessa** lo ven todo: la niña del Rey abrazando a su madre, y el cuchillo. Marek llega un segundo tarde, la cara desencajada de horror.
...
> 🏷️ **LOCACIÓN** · `@selkas-dorm`
> 🏷️ **REPARTO** · `@selka-teen` · `@vera-damaged-1`


La puerta se abre. Entra **@selka-teen.**
...
> 🏷️ **LOCACIÓN** · `⚠️ 3–4 mundos — FALTAN · @loc_mothership-bar · @loc_mothership-hall`
> 🏷️ **REPARTO** · `@brogu` · `@nima` · `@vosk` · `@gara` · `@enko` · `@boro` · `@hessa` · `@sabo` · `@theron` · `@carl` · `@char_lucy` · `@char_noah` · `@char_stella-adult-theron-cloths` · `@gix`
> 🏷️ **PROPS** · `⚠️ mapa del salón — FALTA · ⚠️ proyector — FALTA · ⚠️ 3 cristales — FALTAN`
...
`@loc_mothership-bar`. La mesa llena. **@vosk** contando algo con las manos y **@carl** y **@char_lucy** doblados de risa. **@gara** y **@enko** discutiendo por comida. **@boro** repartiendo platos con tres brazos a la vez.
...
**@char_noah** la mira reírse desde el otro lado de la mesa. Y no dice nada. Y no aparta la mirada.
...
> 🏷️ **LOCACIÓN** · `@space-port · @loc_space-port-lake · @loc_space-port-view`
> 🏷️ **REPARTO** · `@thara` · `@theron` · `@char_stella-adult-theron-cloths` · `@gix`
...
Abajo, sola en la orilla, de espaldas a todos: **@char_stella-adult-theron-cloths.**
...
> 🏷️ **LOCACIÓN** · `@loc_nimas-laboratory`
> 🏷️ **REPARTO** · `@nima` · `@theron` · `@char_noah` · `@stella-therons-armor`
> 🏷️ **PROPS** · `@prop_stella-bracelet · @stella-therons-armor`
...
**@nima** le repasa la raíz. **@stella-therons-armor**, sentada, con la cabeza inclinada.
...
> 🏷️ **LOCACIÓN** · `@loc_erdia-dry · @loc_erdia-destroyed`
> 🏷️ **REPARTO** · `@brogu` · `@nima` · `@vosk` · `@theron` · `@korin-2` · `@char_noah` · `@char_stella-adult-armor`
...
Bajan **@brogu**, **@nima** y **@char_noah.**

Y detrás, una mujer joven con el **pelo teñido de oscuro**, encapuchada: **@char_stella-adult-armor**, ~19.
...
Niebla. Soldados. Murales del Rey por todas partes, y debajo, pintado con bronca, un solo nombre tachado: **@char_stella-adult-armor.**
...
Un grupo de la resistencia los intercepta, los artefactos cargados y en alto. Al frente, más viejo, más cansado: **@korin-2.**
...
Le atan las manos. Ella no opone nada. **@char_noah** aprieta los dientes y tampoco.
...
> 🏷️ **LOCACIÓN** · `@loc_rebel-house`
> 🏷️ **REPARTO** · `@korin-2` · `@char_lessa` · `@char_noah` · `@char_stella-adult-armor`
...
**@char_stella-adult-armor**, con las manos todavía atadas, sentada a un lado.

Y **@korin-2** se acerca a ella. Se agacha. Y le suelta las muñecas él mismo, sin preguntarle a nadie.
...
Silencio. Korin y los veteranos cruzan miradas. A **@char_lessa** se le cae la vista al piso.
...
> 🏷️ **LOCACIÓN** · `@loc_prison-corridor · @loc_prison-cell`
> 🏷️ **REPARTO** · `@brogu` · `@carl` · `@char_lucy` · `@char_noah` · `@char_stella-adult-armor` · `@naio-prison-2`


Cae la luz. Arriba, muy lejos, empieza la guerra: un rumor sordo que hace temblar el polvo del techo.

Aquí abajo, en cambio, silencio. Una reja de servicio cede. Entran **@char_stella-adult-armor**, **@char_noah**, **@carl** y **@char_lucy.**
...
**@naio-prison-2.** Ciego de un ojo. Irreconocible.
...
Un boquete revienta en el muro de la esfera y salen **@char_stella-adult-armor** y **@char_noah** al infierno.
...
Abajo no se aguanta: **se avanza.** Los **@rebel-people** empujan hacia la esfera por encima de las máquinas rotas —cientos, de una docena de pueblos— y la tripulación va delante de ellos abriendo la punta.
...
**@selka-adult-ver-1** —la General, 21, blanca, perfecta, ojos gris-azul, cicatriz sobre el ojo izquierdo, sin un gesto.
...
Primero toma la forma de **@vera-rebel.**
...
**@char_stella-adult-armor.** De pie. Entera. Viva. A tres metros de la Stella de verdad, que se muere en el suelo.
...
> 🏷️ **LOCACIÓN** · `@loc_erdia-future-sky · @loc_erdia-square-destroyed`
> 🏷️ **REPARTO** · `@theron` · `@korin-2` · `@vortham-parasite`
> 🏷️ **PROPS** · `@mothership`
...
**@korin-2** entre ellos, de pie en mitad de la plaza, mirando el agujero del cielo por donde se fue lo que llevaba veinte años encima de sus cabezas.
